...
/// A class that contains all theme configurations for the professional job search application.
class AppTheme {
  AppTheme._();

  // Professional Trust Palette - Color specifications
  static const Color primaryLight =
      Color(0xFF0077B5); // LinkedIn professional blue
  static const Color secondaryLight =
      Color(0xFF00A0DC); // Lighter blue for secondary actions
  static const Color successLight =
      Color(0xFF057642); // Application approved status
  static const Color warningLight =
      Color(0xFFB45309); // Pending application status
  static const Color errorLight = Color(0xFFDC2626); // Rejection status
  ...
  static const Color textPrimaryLight = Color(0xFF1F2937); // Main content text
  static const Color textSecondaryLight = Color(0xFF6B7280); // Supporting text
  static const Color borderLight =
      Color(0xFFE5E7EB); // Form inputs and card separation

  // Dark theme colors (maintaining professional consistency)
  static const Color primaryDark = Color(0xFF00A0DC);
  static const Color secondaryDark = Color(0xFF0077B5);
  ...
  /// Light theme for professional job search application
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for professional navigation
    ...
    // Card theme for job listings and content sections
    cardTheme: CardTheme(
      color: surfaceLight,
      elevation: 2.0,
      shadowColor: shadowLight,
    ...
    // Bottom navigation theme for main navigation
  ...
  /// Dark theme for professional job search application
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for job titles and card headers
